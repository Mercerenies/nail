...
function OreganoBuyGent() : Customer() constructor {

  var common1 = Util.sample(ctrl_ItemLists.commonList);
  var common2 = Util.sample(ctrl_ItemLists.commonList);
  _items = [new SkullRing(), new Knife(), common1, common2, new Briefcase(), new Briefcase()]
  ...
  static onIntroduce = function() {
    Inventory.suggestTrade([ItemId.OREGANO], [ItemId.BRIEFCASE, ItemId.BRIEFCASE]);
    obj_DialogueBox.enqueue(new DiaText("Hey kid, can I have some of that oregano?", true));
  }

  static onTradeAttempt = function() {
    standardTradeAttempt(new _OreganoBuyGent_TradeRule());
  }

}

function _OreganoBuyGent_TradeRule() : TradeRule() constructor {
  ...
  static playerValuation = function() { return new OreganoGentValuator(); }
